...
.. note::
   The nRF54L15 has support for DFU with image compression, which may eliminate the need for external flash.
...
.. tabs::
   ...
   .. tab:: nRF54L10 emulation on nRF54L15 DK
      ...
      The following memory map is valid for Matter applications running on the :ref:`nRF54L15 DK <programming_board_names>` (:ref:`nrf54l15dk/nrf54l10/cpuapp <zephyr:nrf54l15dk_nrf54l10`).
...
.. tabs::
   ...
   .. tab:: nRF54L10 emulation on nRF54L15 DK
    ...
    The following RAM memory layout is valid for Matter applications running on the :ref:`nRF54L15 DK <programming_board_names>` (:ref:`nrf54l15dk/nrf54l10/cpuapp <zephyr:nrf54l15dk_nrf54l10>`).

    Base SRAM size (size: 0x30000 = 192kB)
    SRAM is located at the address ``0x20000000`` in the memory address space of the application.

      +-------------------------------+----------------------+----------------------+
      | Partition                     | Offset               | Size                 |
      +===============================+======================+======================+
      | Application Core SRAM primary | 0 (0x0)              | 184.8125kB (0x2E340) |
      +-------------------------------+----------------------+----------------------+
      | Crash retention               | 184.8125kB (0x2E340) | 192B (0xC0)          |
      +-------------------------------+----------------------+----------------------+
      | Network Logs retention        | 185kB (0x2E400)      | 6k (0x1800)          |
      +-------------------------------+----------------------+----------------------+
      | User Data Logs retention      | 191kB (0x2FC00)      | 1k (0x400)           |
      +-------------------------------+----------------------+----------------------+
